...
def fake_time(arg):
    return '2014-01-01T00:00:00.000000'


class CapabilitiesTests(test_router_db.RouterDBTestBase):

    @mock.patch('neutron.openstack.common.timeutils.strtime', side_effect=fake_time)
    def test_floating_ip_capability(self, fake_time):
        with contextlib.nested(
            ...
            with self.floatingip_with_assoc() as fip:
                fip['floatingip']['created_at'] = '2014-01-01T00:00:00.000000'
