...
class LoadBalancerBaseDriver(object):
    ...
    l7_policy = NotImplementedManager()
    l7_rule = NotImplementedManager()
...
class BaseL7PolicyManager(driver_mixins.BaseDeleteHelperMixin,
                          driver_mixins.BaseManagerMixin):
...
class BaseL7RuleManager(driver_mixins.BaseManagerMixin):
    ...
    def db_delete(self, context, model_id, parent_id):
        self.db_delete_method(context, model_id, parent_id)
