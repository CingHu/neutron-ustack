...
RESOURCE_ATTRIBUTE_MAP = {
    RESOURCE_NAME + 's': {
        'id': {'allow_post': False, 'allow_put': False,
               ...
               'is_visible': True},
        'agent_type': {'allow_post': True, 'allow_put': False,
                       'is_visible': True},
        'binary': {'allow_post': True, 'allow_put': False,
                   'is_visible': True},
        'topic': {'allow_post': True, 'allow_put': False,
                  'is_visible': True},
        ...
        'reserved': {'allow_post': True, 'allow_put': True,
                     'convert_to': attr.convert_to_boolean,
                     'is_visible': True,
                     'default': True},
    },
...
class AgentNotFoundByAgentType(exceptions.NotFound):
    message = _("Agent %(agent_type)s could not be found")
