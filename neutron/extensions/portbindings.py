...
# Add a new attribute to port named 'binding:disable_anti_spoofing', this
# attribute is use to control if port can use anti-spoofing.
DISABLE_ANTI_SPOOFING = 'binding:disable_anti_spoofing'

# Default value for SPOOFING
DEFAULT_SPOOFING = False
...
EXTENDED_ATTRIBUTES_2_0 = {
    'ports': {
        ...
        PROFILE: {'allow_post': True, 'allow_put': True,
                  ...
                  'is_visible': True},
        DISABLE_ANTI_SPOOFING: {'allow_post': False, 'allow_put': True,
                   'default': DEFAULT_SPOOFING,
