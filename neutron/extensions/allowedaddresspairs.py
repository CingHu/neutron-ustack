...
allowed_address_uos_opts = [
    cfg.StrOpt('limit_network_for_pair', default=[],
               help=_("Networks which shouldn't use allowed address pairs")),
]

cfg.CONF.register_opts(allowed_address_pair_opts)
cfg.CONF.register_opts(allowed_address_uos_opts, 'unitedstack')
...
class NetwrokNotAllowed(nexception.BadRequest):
    message = _("The network %(network)s is not allowed to set "
