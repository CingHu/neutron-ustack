...
class IptablesFirewallDriver(firewall.FirewallDriver):
    ...
    IPTABLES_DIRECTION = {INGRESS_DIRECTION: 'i',
                          EGRESS_DIRECTION: 'o'}
    ...
    def prepare_port_filter(self, port):
        LOG.info(_("Preparing device (%s) filter"), port['device'])
        self._remove_chains()
    ...
    def _add_chain(self, port, direction):
        ...
        self._add_rule_to_chain_v4v6('OUTPUT', jump_rule, jump_rule)
