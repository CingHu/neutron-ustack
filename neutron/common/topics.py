...
DHCP = 'q-dhcp-notifer'
SERVICEVM= 'q-servicevm-notifer'
FIREWALL_PLUGIN = 'q-firewall-plugin'
METERING_PLUGIN = 'q-metering-plugin'
LOADBALANCER_PLUGIN = 'n-lbaas-plugin'
TUNNEL_PLUGIN = 'n-tunnelaas-plugin'
SERVICEVM_PLUGIN = 'n-servicevm-plugin'

L3_AGENT = 'l3_agent'
DHCP_AGENT = 'dhcp_agent'
METERING_AGENT = 'metering_agent'
LOADBALANCER_AGENT = 'n-lbaas_agent'
TUNNEL_AGENT = 'tunnel_agent'
SERVICEVM_AGENT = 'servicevm_agent'
